...
// Pega um evento
// MOUSE:
//  x,y: 0-based indexes (0,0) top left corner
//  button: Qual botao foi pressionado
//  motion: se teve movimento continuo com o mesmo botão
//  scroll: Se teve scroll, para cima ou para baixo
//  modifier: CTRL, ALT e/ou SHIFT
// KEY
